    ...
    <div class="bg-white py-1">
        <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 sm:col-span-3 my-2 sm:my-0">
                    <img src="{{asset('images/logo1.png')}}" alt="Logo" class="w-32 mx-auto sm:ml-0">
                </div>
                <div class="col-span-12 sm:col-span-6 my-10">
                    <ul class="flex  flex-wrap justify-center sm:justify-between text-center font-bold">
                        <li class="mr-8 mb-4 sm:mb-0 hover:text-blue-700" style=""><a href="#">Mobile App</a></li>
                        <li class="mr-8 mb-4 sm:mb-0 hover:text-blue-700"><a href="#">Community</a></li>
                        <li class="mr-8 mb-4 sm:mb-0 hover:text-blue-700"><a href="#">Company</a></li>
                        <li class="mr-8 mb-4 sm:mb-0 hover:text-blue-700"><a href="#">Help desk</a></li>
                        <li class="mr-8 mb-4 sm:mb-0 hover:text-blue-700"><a href="#">Blog</a></li>
                    </ul>
                    <hr class="border-t border-black text-center max-w-2xl mx-auto sm:mt-2 mb-2">
                    <p class="text-center">© ImagesPro.com All rights reserved (2023)</p>
                </div>
                <div class="col-span-12 sm:col-span-3 my-2">
                    <p class="text-center font-bold mb-4 md:text-lg">Follow Us</p>
                    <ul class="flex justify-center sm:justify-center">
                        <li class="mr-4">
                            {{-- svg1 --}}
                    ...
                    <p class="text-center my-2">All uploaded data is deleted after 1 hour.</p>
                </div>
            </div>
        </div>
    </div>
